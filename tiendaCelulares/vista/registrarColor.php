...
<head>
    ...
    <style>
        ...
        .header {
            position: relative; /* Agregado para el botón de regresar */
            background: #2b6cb0;
            color: white;
            padding: 18px;
            text-align: center;
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="container">
            <div class="title">Registrar Color</div>
        ...
        <!-- DERECHA: TABLA -->
        <div class="container">
            <div class="title">Colores registrados</div>
            ...
            <table>
                ...
                <?php foreach($colores as $fila): ?>
                <tr>
                    <td><?php echo $fila['id']; ?></td>
                    <td><?php echo $fila['nombre']; ?></td>
                    <td>
                        <!-- Formulario para borrar el color -->
                        <form action="../controlador/eliminarColor.php" method="POST" style="margin: 0;">
                            <input type="hidden" name="id_color" value="<?php echo $fila['id']; ?>">
                            <button type="submit" class="btn-eliminar" onclick="return confirm('¿Seguro que quieres borrar este color?');">Borrar</button>
                        </form>
                    </td>
                </tr>
                <?php endforeach; ?>
